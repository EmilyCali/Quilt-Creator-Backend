...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { difficulty: @block.difficulty, title: @block.title } }, as: :json
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { difficulty: @block.difficulty, title: @block.title } }, as: :json
    assert_response 200
  end
